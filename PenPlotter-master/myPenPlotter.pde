...
import java.text.*;
import java.util.*;
//import java.io.*; // https://www.reddit.com/r/processing/comments/17c1aqs/type_serial_is_ambiguous/
...
import java.awt.BorderLayout;
    ...
    public void changeAppIcon(PImage img) {
        ...
        pg.endDraw();
        console.frame.setIconImage(pg.image);
    }

    public void changeAppTitle(String title) {
        //surface.setTitle(title);
        console.frame.setTitle(title);
    }
