 DropdownList connectDropList;
    ...
    public void controlEvent(ControlEvent theEvent) {
       ...
       if (theEvent.isController()) {
            ...
            if (Integer.parseInt(props.getProperty("final_project_mode")) == 1){
              if (startup == 0){
                println("default USB input: final_project_mode="+ Integer.parseInt(props.getProperty("final_project_mode")) + " USB name=" + props.getProperty("usb_name"));
                com.connect(props.getProperty("usb_name"));
  
                println("default output file");
                loadVectorFile();
                startup = 1;
              }
            }
        ...
        if (Integer.parseInt(props.getProperty("final_project_mode")) == 1){
           if (startup == 1){
              if (currentPlot.isLoaded()){
                println("Default begin plotting...");
                currentPlot.plot();
              }
           }
        }
