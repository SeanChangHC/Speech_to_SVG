...
import java.awt.BorderLayout;
    ...
    public void changeAppIcon(PImage img) {
        ...
        pg.endDraw();
        //frame.setIconImage(pg.image);Dtring
    }
    ...
    //}
        ...
        usb_name = props.getProperty("usb_name");
        ...
        final_project_mode = Integer.parseInt(props.getProperty("final_project_mode"));
        println("final_project_mode="+final_project_mode);
    }
