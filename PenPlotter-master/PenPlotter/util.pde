   ...
   String ext;
        ...
        SwingUtilities.invokeLater(new Runnable()
                                   {
                                       public void run() {
                                         String name = currentFileName;
                                           ...
                                           fc.showSaveDialog(console.frame);
    ...
    public void saveProperties() {
        ...
        try {
            ...
            props.setProperty("final_project_mode",""+final_project_mode);
            props.setProperty("usb_name",currentFileName);
        ...
        SwingUtilities.invokeLater(new Runnable()
                                   {
                                       public void run() { //<>//
                                           ...
                                           if (currentFileName != null)
                                               fc.setSelectedFile(new File("/home/michaelc/PenPlotter-master/output/sentence.svg"));
                                           //fc.setDialogTitle("Choose a vector file...");
                                           int returned = JFileChooser.APPROVE_OPTION;//fc.showOpenDialog(null); // needed this to be null huh??? //<>//
